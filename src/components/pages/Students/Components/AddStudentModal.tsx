...
interface AddStudentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: Omit<CreateStudentRequest, "schoolId">) => Promise<void>;
  schoolId: string;
}
...
export const AddStudentModal = ({
  ...
  const [selectedEducationLevels, setSelectedEducationLevels] = useState<
    string[]
  >([]);
  const [selectedEducationSystems, setSelectedEducationSystems] = useState<
    string[]
  >([]);
      ...
      await onSubmit({
        ...
        educationLevelId:
          selectedEducationLevels.length > 0
            ? parseInt(selectedEducationLevels[0])
            : 0,
        educationSystemId:
          selectedEducationSystems.length > 0
            ? parseInt(selectedEducationSystems[0])
            : 0,
  ...
  return (
    <FormModal
      ...
      description="Add a new student to the school with their enrollment information."
